                ...
                <tbody class="align-middle">
                    @foreach ($users as $key => $user)
                        <tr>
                            ...
                            <td><a style="cursor: pointer;" class="deleted" onclick="deleteCategory({{$user->id}})"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">

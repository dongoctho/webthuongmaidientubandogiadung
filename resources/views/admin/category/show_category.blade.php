                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <div class="" style="display: flex; margin-left:10px; flex-direction:column; margin-top:30px">
                                ...
                                </div><input style="height:50px" required="required" type="text" name="code" value="{{$categories->code}}" class="form-control"
                        ...
                        <div class="col-sm-6">
                            <div class="" style="display: flex; margin-right:10px; flex-direction:column; margin-top:30px">
                                ...
                                <input style="height:50px" type="text" required="required" name="name" value="{{$categories->name}}" class="form-control"

        ...
        <div class="card-body">
          ...
          <table  style="text-align: center" id="example1" class="table">
                ...
                <tr>
                    ...
                    <td><a href="{{route('list_cart_detail', ['id_user' => $cart->user_id, 'id'=>$cart->id])}}"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">

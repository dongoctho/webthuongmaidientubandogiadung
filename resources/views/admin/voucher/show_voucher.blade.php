                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <div style="width: 500px; margin-top:50px; margin-left:10px" class="flex-nowrap" style="display: flex; flex-direction:column;">
                                ...
                                <input required="required" style="height:50px" type="text" name="code" value="{{$vouchers->code}}" class="form-control"
                        ...
                        <div class="col-sm-6">
                            <div style="width: 500px; margin-top:50px;  margin-left: 70px" class="flex-nowrap" style="display: flex; flex-direction:column;">
                                ...
                                <input required="required" style="height:50px" type="text" name="name" value="{{$vouchers->name}}" class="form-control"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <div style="width: 500px; margin-top:30px;  margin-left: 70px" class="flex-nowrap" style="display: flex; flex-direction:column;">
                                ...
                                <input required="required" style="height:50px" type="text" name="discount" value="{{$vouchers->discount}}" class="form-control"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <div style="width: 500px; margin-top:30px;  margin-left: 10px" class="flex-nowrap" style="display: flex; flex-direction:column;">
                                ...
                                <input required="required" style="height:50px" type="text" name="quantity" value="{{$vouchers->quantity}}" class="form-control"

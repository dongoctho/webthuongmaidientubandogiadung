                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" name="name" value="{{Auth::user()->name}}" disabled type="text">
                        </div>
                        <div class="col-md-6 form-group">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" type="text" name="ward" placeholder="Xã/Phường...">
                            <div class="" style="">
                                @if ($errors->all())
                        ...
                        <div class="col-md-6 form-group">
                            <label>Số Nhà</label>
                            <input class="form-control" type="text" name="homenumber" placeholder="Số Nhà...">
                            <div class="" style="">
                                @if ($errors->all())
